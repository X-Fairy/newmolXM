        ...
        <div class="main" >
            ...
            <div class="info1">
                ...
                <ul>
                    ...
                    <li>
                        <div>
                            <p>10年行业沉淀</p>
                            <span>大数据基础、团队基础、供应链基础</span>
                        </div>
                        <img src="@/assets/images/addvantage/3.jpg" alt="">
                    </li>
                    <li>
                        <div>
                            <p>二店率高达38%</p>
                    ...
                    <li>
                        <div>
                            <p>供应链</p>
                            <span>6000款SKU，百分百全系列定制产品，品质有保证，首批货品百分百调换货政策</span>
                        </div>
                        <img src="@/assets/images/addvantage/201.jpg" alt="">
                    </li>
                    <li style="width: 49%">
                        <div>
                            <p>整店输出</p>
                            <span>选址、开店、货品供给、督导下店，全程持续服务，让加盟商开店无忧</span>
                        </div>
                        <img src="@/assets/images/addvantage/21.jpg" alt="">
                    </li>
                    <li style="width: 49%">
                        <div>
                            <p>天下武功，唯快不破</p>
                            <span>平均每个月800款新品的速度，同行业的标杆</span>
                        </div>
                        <img src="@/assets/images/addvantage/22.jpg" alt="">
                    </li>
                </ul>
                <img src="@/assets/images/addvantage/8.jpg" alt="">
                <img src="@/assets/images/addvantage/10.jpg" alt="">
                <img src="@/assets/images/addvantage/11.jpg" alt="">
            </div>
            <div class="info2">
                <div class="f1">
                ...
                <ul>
                    ...
                    <li>
                        <p>店面选址</p>
                        <span>商圈顾客评估优选最佳开店地址</span>
                    </li>
                    <li>
                        <p>整店VI装修</p>
                        <span>提供整体VI把控 店面图纸设计</span>
                    </li>
                    <li>
                        <p>智能ERP系统</p>
                        <span>海鼎ESHOP智能ERP收银软件</span>
                    </li>
                    <li>
                        <p>运营筹备</p>
                ...
                <img src="@/assets/images/addvantage/12.jpg" alt="">

            </div>
            <div class="info3">
                <div class="f1">
                    <p class="p1">Return On Investment</p>
                    <p class="p2">投资回报</p>
                </div>
                <div class="ximei">
            ...
            <div class="info4">
                <div class="f1" style="background:#fff;">
                    <p class="p1">Open for Business</p>
                    <p class="p2">开店启动周期分布</p>
                </div>
                <img src="@/assets/images/addvantage/18.jpg" alt="">
                <ul class="item">
