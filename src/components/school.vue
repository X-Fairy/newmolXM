<template>
    <div class="school">
        ...
        <div class="main" style="background:#f0f0f0;">
             <img src="@/assets/images/school/index1.png" alt="">
            <div class="school1">
                <h2 class="h1">Business School</h2>
                <h3 class="h2">商学院简介</h3>
                <p class="jieshao">熙美诚品商学院成立于2015年，服务全球加盟商。</p>
                <p class="jieshao">截止2019年10月，熙美诚品商学院已举办38期“金牌加盟商培训会”，小型精品培训会14期，培训人次近2000人。分别在北京、广州、南京、西安、重庆、成都等地开课，持续为加盟商后续经营保驾护航。</p>
                <ul class="hexin">
                    <li>
                        <div>
                            <span>理念</span>
            ...
            <div class="school2">
                ...
                <div class="f1">
                    ...
                    <img src="@/assets/images/school/index2.png" alt="">
                
            </div>
            <div class="school3">
                <div class="f1">
                    <p class="p1">Training Photo</p>
                    <p class="p2">导培训会一览</p>
                </div>
                <img src="@/assets/images/school/index3.png" alt="">
            </div>
